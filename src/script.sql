create database if not exists DbEfm;
use DbEfm;
...
insert into Appartement values ("omar",2,1);
insert into Appartement values ("marouan",3,2);
insert into Appartement values ("najib",5,3);
insert into Appartement values ("ilyasse",6,4);